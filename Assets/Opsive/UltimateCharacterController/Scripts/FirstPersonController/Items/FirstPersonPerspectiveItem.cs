    ...
    public class FirstPersonPerspectiveItem : PerspectiveItem
    {
        ...
        private FirstPersonObjects GetFirstPersonObjects(GameObject character)
        {
            ...
            if (firstPersonObjects == null) {
                ...
                if (foundCamera != null) {
                    return foundCamera.GetComponentInChildren<FirstPersonObjects>(true);
                }
            }
        ...
        private void UpdateStep()
        {
            ...
            if (elevating && !m_BobWasElevating) {
                ...
                m_PivotPositionSpring.AddForce(m_StepForceScale * m_CharacterLocomotion.TimeScale * Time.timeScale * positionForce, m_StepSoftness);
                m_PivotRotationSpring.AddForce(m_StepForceScale * m_CharacterLocomotion.TimeScale * Time.timeScale * rotationForce, m_StepSoftness);
            }
        ...
        private void ApplyMovement()
        {
            ...
            for (int i = 0; i < m_AdditionalControlObjectsTransform.Length; ++i) {
                m_AdditionalControlObjectsTransform[i].SetPositionAndRotation(m_ObjectTransform.position, m_ObjectTransform.rotation);
            }
        }
        ...
        private void SnapSprings(bool fromEquip, bool resetSpring = true)
        {
            ...
            if ((!fromEquip && (Utility.UnityEngineUtility.HasUpdatedObject(m_Object) || !IsActive())) || !m_Item.DominantItem) {
                return;
            }
        ...
        public override void ResetInitialization()
        {
            ...
            if (m_VisibleItem != null) {
                m_VisibleItem.transform.SetParent(m_Item.transform);
            }

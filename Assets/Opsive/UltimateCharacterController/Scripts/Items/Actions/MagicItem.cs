...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public class MagicItem : UsableItem
    {
        ...
        public CastUseType UseType { get { return m_UseType; }
            set
            {
                if (m_UseType == value) { return; }
                m_UseType = value; if (m_UseType != CastUseType.Continuous) { m_ContinuousCast = false; }
            }
        }
        ...
        public void DeserializeBeginActions(bool forceDeserialization)
        {
            ...
            if (m_BeginActionData != null) {
                ...
                for (int i = 0; i < m_BeginActions.Length; ++i) {
                    ...
                    if (Application.isPlaying && m_Character != null) { // m_Character will be null on prefabs.

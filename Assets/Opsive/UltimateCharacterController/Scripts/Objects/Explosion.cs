...
namespace Opsive.UltimateCharacterController.Objects
{
    ...
    public class Explosion : MonoBehaviour
    {
        ...
        [Tooltip("Should the object use the explosion damage instead of the impact damage?")]
        [SerializeField] protected bool m_OverrideImpactDamage;
        ...
        public bool OverrideImpactDamage { get { return m_OverrideImpactDamage; } set { m_OverrideImpactDamage = value; } }
        ...
        {
            // Optionally prevent the impact damage from being used.
            if (m_OverrideImpactDamage) {

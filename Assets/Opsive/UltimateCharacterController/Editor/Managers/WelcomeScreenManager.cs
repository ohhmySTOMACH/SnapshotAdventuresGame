...
namespace Opsive.UltimateCharacterController.Editor.Managers
{
    ...
    public class WelcomeScreenManager : Manager
    {
        ...
        private const string c_Version3TextureGUID = "c7599685c5d66f8409d0ecc441c08e8e";
        ...
        public override void Initialize(MainManagerWindow mainManagerWindow)
        {
            ...
            m_Version3Texture = FindTexture(c_Version3TextureGUID);
        }
        ...
        public override void OnGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            width = m_MainManagerWindow.position.width - m_MainManagerWindow.MenuWidth - m_Version3Texture.width;
            GUILayout.Space(width / 2);
            GUILayout.Label(m_Version3Texture, Shared.Editor.Inspectors.Utility.InspectorStyles.CenterLabel, GUILayout.Width(m_Version3Texture.width), GUILayout.Height(m_Version3Texture.height));
            lastRect = GUILayoutUtility.GetLastRect();
            if (Event.current.type == EventType.MouseUp && lastRect.Contains(Event.current.mousePosition)) {

                switch (UltimateCharacterController.Utility.AssetInfo.Name) {
                    case "Ultimate Character Controller":
                        Application.OpenURL("https://assetstore.unity.com/packages/slug/233710?aid=1100lGdc");
                        break;
                    case "First Person Controller":
                    case "Ultimate First Person Shooter":
                    case "Ultimate First Person Melee":
                        Application.OpenURL("https://assetstore.unity.com/packages/slug/233711?aid=1100lGdc");
                        break;
                    case "Third Person Controller":
                    case "Ultimate Third Person Shooter":
                    case "Ultimate Third Person Melee":
                        Application.OpenURL("https://assetstore.unity.com/packages/slug/233712?aid=1100lGdc");
                        break;
                }
            }
            GUILayout.EndHorizontal();

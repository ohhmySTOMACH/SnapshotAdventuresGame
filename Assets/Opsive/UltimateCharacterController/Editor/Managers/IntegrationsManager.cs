    ...
    public class IntegrationsManager : Manager
    {
        ...
        private static GUIStyle IntegrationAssetTitle
        {
            get
            {
                if (s_IntegrationAssetTitle == null) {
                    s_IntegrationAssetTitle = new GUIStyle(Shared.Editor.Inspectors.Utility.InspectorStyles.CenterBoldLabel);
        ...
        private void DrawIntegrationInspectors()
        {
            ...
            for (int i = 0; i < m_IntegrationInspectors.Length; ++i) {
                ...
                GUILayout.Label(m_IntegrationNames[i], Shared.Editor.Inspectors.Utility.InspectorStyles.LargeBoldLabel);
                GUILayout.Space(4);
        ...
        private void DrawAvailableIntegrations()
        {
            ...
            GUILayout.Space(-3);
            if (GUILayout.Button("integrations page.", Shared.Editor.Inspectors.Utility.InspectorStyles.LinkStyle, GUILayout.Width(106))) {

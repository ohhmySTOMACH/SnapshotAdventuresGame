...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.FirstPersonController.Camera.ViewTypes
{
    ...
    public class FirstPersonInspectorDrawer : ViewTypeInspectorDrawer
    {
        ...
        public override void OnInspectorGUI(object target, Object parent)
        {
            ...
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "Rendering")) {
                ...
                var lookOffset = EditorGUILayout.Vector3Field(
                    new GUIContent(ObjectNames.NicifyVariableName("m_LookOffset"), InspectorUtility.GetFieldTooltip(target, "m_LookOffset")), lookOffsetValue);
...
#endif
                if (drawFirstPersonCamera && Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "First Person Camera")) {
                    EditorGUI.indentLevel++;
                    ...
                    var positionOffset = EditorGUILayout.Vector3Field(new GUIContent(
                        ObjectNames.NicifyVariableName("m_FirstPersonPositionOffset"), InspectorUtility.GetFieldTooltip(target, "m_FirstPersonPositionOffset")), positionOffsetValue);
                    // Set the property if the game is playing so the camera will update.
                    ...
                    var rotationOffset = EditorGUILayout.Vector3Field(new GUIContent(
                        ObjectNames.NicifyVariableName("m_FirstPersonRotationOffset"), InspectorUtility.GetFieldTooltip(target, "m_FirstPersonRotationOffset")), rotationOffsetValue);
            ...
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "Primary Spring")) {
                ...
                var lowerLimitValue = EditorGUILayout.Slider(new GUIContent(
                                        ObjectNames.NicifyVariableName("m_PositionLowerVerticalLimit"), 
            ...
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "Shake")) {
                EditorGUI.indentLevel++;
                InspectorUtility.DrawFieldSlider(target, "m_ShakeSpeed", 0, 10);
                InspectorUtility.DrawField(target, "m_ShakeAmplitude");
                EditorGUI.indentLevel--;
            }
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "Bob")) {
                EditorGUI.indentLevel++;
            ...
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "Head Tracking")) {
                EditorGUI.indentLevel++;
                ...
                InspectorUtility.DrawField(target, "m_VerticalOffsetLerpSpeed");
                EditorGUI.indentLevel--;
            }
        }
    }

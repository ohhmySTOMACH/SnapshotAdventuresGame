...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Character
{
    ...
    public class UltimateCharacterLocomotionInspector : StateBehaviorInspector
    {
            ...
            baseCallback += () =>
            {
                ...
                if (Foldout("Motor")) {
                    ...
                    if (Application.isPlaying) {
                        ...
                        var timeScaleValue = EditorGUILayout.Slider(new GUIContent(ObjectNames.NicifyVariableName(timeScaleProperty.name), timeScaleProperty.tooltip), timeScaleProperty.floatValue, 0, 4);
        ...
        private void AddMovementType(object obj)
        {
            ...
            SerializeMovementTypes();
#if UNITY_2021_2_OR_NEWER
            m_ReorderableMovementTypeList.list = m_CharacterLocomotion.MovementTypes;
#endif
...
#if UNITY_2021_2_OR_NEWER
            m_ReorderableAbilityList.list = m_CharacterLocomotion.Abilities;
#endif
...
#if UNITY_2021_2_OR_NEWER
            m_ReorderableItemAbilityList.list = m_CharacterLocomotion.ItemAbilities;
#endif
        ...
        private void AddEffect(object obj)
        {
            ...
            SerializeEffects();
#if UNITY_2021_2_OR_NEWER
            m_ReorderableEffectList.list = m_CharacterLocomotion.Effects;
#endif
        ...
        private void OnMovementTypeListRemove(ReorderableList list)
        {
            ...
            var removedMovementType = movementTypes[list.index].GetType().FullName;

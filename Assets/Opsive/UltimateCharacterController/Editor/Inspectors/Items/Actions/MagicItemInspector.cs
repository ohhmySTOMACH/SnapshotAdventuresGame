...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Items.Actions
{
    ...
    public class MagicItemInspector : UsableItemInspector
    {
            ...
            baseCallback += () =>
            {
                if (Foldout("Magic")) {
                    ...
                    if (useTypeProperty.enumValueIndex == (int)MagicItem.CastUseType.Continuous) {
                        ...
                        EditorGUI.indentLevel--;
                    } else if (PropertyFromName("m_ContinuousCast").boolValue) {
                        PropertyFromName("m_ContinuousCast").boolValue = false;
                    }
                    ...
                    if (Foldout("Events")) {
                        EditorGUI.indentLevel++;
                        Shared.Editor.Inspectors.Utility.InspectorUtility.UnityEventPropertyField(PropertyFromName("m_OnStartStopBeginEndActionsEvent"));
                        Shared.Editor.Inspectors.Utility.InspectorUtility.UnityEventPropertyField(PropertyFromName("m_OnCastEvent"));
        ...
        private void AddBeginAction(object obj)
        {
            ...
            m_ReorderableBeginActionList.list = m_MagicItem.BeginActions;
#endif
        ...
        private void AddCastAction(object obj)
        {
            ...
            SerializeCastActions();
#if UNITY_2021_2_OR_NEWER
            m_ReorderableCastActionList.list = m_MagicItem.CastActions;
#endif
        ...
        private void AddImpactAction(object obj)
        {
            ...
            SerializeImpactActions();
#if UNITY_2021_2_OR_NEWER
            m_ReorderableImpactActionList.list = m_MagicItem.ImpactActions;
#endif
        ...
        private void AddEndAction(object obj)
        {
            ...
            SerializeEndActions();
#if UNITY_2021_2_OR_NEWER
            m_ReorderableEndActionList.list = m_MagicItem.EndActions;
#endif
        ...
        private void DrawSelectedBeginAction(int index)
        {
            ...
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(selectedBeginAction, new GUIContent("States"), false)) {
        ...
        private void DrawSelectedCastAction(int index)
        {
            ...
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(selectedCastAction, new GUIContent("States"), false)) {
        ...
        private void DrawSelectedImpactAction(int index)
        {
            ...
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(selectedImpactAction, new GUIContent("States"), false)) {
        ...
        private void DrawSelectedEndAction(int index)
        {
            ...
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(selectedEndAction, new GUIContent("States"), false)) {
        ...
        private void OnBeginActionStateListReorder(ReorderableList list)
        {
            ...
            var copiedStates = new Shared.StateSystem.State[beginAction.States.Length];
        ...
        private void OnCastActionStateListReorder(ReorderableList list)
        {
            ...
            // Use the dummy array in order to determine what element the selected index was swapped with.
            var copiedStates = new Shared.StateSystem.State[castAction.States.Length];
        ...
        private void OnImpactActionStateListReorder(ReorderableList list)
        {
            ...
            // Use the dummy array in order to determine what element the selected index was swapped with.
            var copiedStates = new Shared.StateSystem.State[impactAction.States.Length];
        ...
        private void OnEndActionStateListReorder(ReorderableList list)
        {
            ...
            // Use the dummy array in order to determine what element the selected index was swapped with.
            var copiedStates = new Shared.StateSystem.State[endAction.States.Length];
